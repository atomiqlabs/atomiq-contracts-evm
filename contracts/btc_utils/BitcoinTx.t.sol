...
contract BitcoinTxWrapper {
    ...
    function getVersion(BitcoinTx memory self) pure external returns (uint256 result) {
    ...
    function getInputNSequence(BitcoinTx memory self, uint256 vin) pure external returns (uint256) {
